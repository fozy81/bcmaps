...
[British National Grid](https://spatialreference.org/ref/epsg/27700) projection, which is the Scottish Government standard as `sf` objects.

Layers are assessed directly from the [spatialdata.gov.scot](https://www.spatialdata.gov.scot/) catalogue. See each layer's individual help file for more detail.
...
To install the development version of the `scotmaps` package, you need to install the `remotes` package then the `scotmaps` package.
...
To report bugs/issues/feature requests, please file an [issue](https://github.com/fozy81/openmaps/issues/).
